...
const layout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="min-h-screen  flex">
      ...
      <div className="w-full h-full bg-gradient-to-br from bg-blue-600 via-blue-700 to-blue-600 flex justify-center items-center">
        <div className="text-center text-white p-8 max-w-md">
          <div className="w-20 h-20 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-6 backdrop-blur-2xl">
            <svg
          ...
          <div>
            ...
            <h2 className="text-2xl opacity-90 mb-3">Your health, our priority</h2>
